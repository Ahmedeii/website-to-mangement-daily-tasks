...
// ..
        ...
        <form action="">
                ...
                .catch((error) => {
                  ...
                  switch (errorCode) {
                    case "auth/invalid-email" :
                      setfirebaseerror("write email corccet way")
                      break;
                    case 'auth/missing-password' :
                      setfirebaseerror("write password ")
                      break;
                    case 'auth/invalid-login-credentials' :
                      setfirebaseerror("write email or password corecct ")
                      break;
          ...
          <p >
          {i18n.language ==="en" && "  don't have acount"}  {i18n.language ==="ar" && "اذا كنت لا تملك حساب"} {i18n.language ==="fr" && "nou have accountoe"}<Link to="/Signup">{i18n.language ==="en" && "sign-up"}{i18n.language ==="fr" && "signe-up"}{i18n.language ==="ar" && "سجل الدخول"}</Link>
          </p>
